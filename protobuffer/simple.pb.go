...
func (x *Simple) GetStrField() string {
	if x != nil {
		return x.StrField
	}
	return ""
...
func (x *Simple) GetBytes1Field() []byte {
	if x != nil {
		return x.Bytes1Field
	}
	return nil
}

func (x *Simple) GetBytes2Field() []byte {
	if x != nil {
		return x.Bytes2Field
	}
	return nil
}

func (x *Simple) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *SimpleArr) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimpleArr) ProtoMessage() {}

func (x *SimpleArr) ProtoReflect() protoreflect.Message {
	mi := &file_simple_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SimpleArr.ProtoReflect.Descriptor instead.
func (*SimpleArr) Descriptor() ([]byte, []int) {
	return file_simple_proto_rawDescGZIP(), []int{1}
}

func (x *SimpleArr) GetSimples() []*Simple {
	if x != nil {
		return x.Simples
	}
	return nil
...
var file_simple_proto_rawDesc = []byte{
	...
	,
...
var file_simple_proto_goTypes = []interface{}{
	(*Simple)(nil),    // 0: pb.Simple
	(*SimpleArr)(nil), // 1: pb.SimpleArr
}
var file_simple_proto_depIdxs = []int32{
	0, // 0: pb.SimpleArr.Simples:type_name -> pb.Simple
